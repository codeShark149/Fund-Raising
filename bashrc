...
# Aliases for playing with elemets
...
#BDB Directory for Bitcoin compilation
export BDB_PREFIX='/home/raj/github-repo/bitcoin/db4'

# Bitcoin FUZZING---------------------
export DIR_FUZZ_IN=$HOME/bitfuzz/qa-assets/fuzz_seed_corpus
export AFLOUT=$HOME/bitfuzz/outputs
export AFLPATH=$HOME/bitfuzz/afl-2.52b
export FUZZ_TARGET=utxo_total_supply

# Add tor execs to path
export PATH="$HOME/Downloads/tor-browser_en-US/Browser:$PATH"
